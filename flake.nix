{
  ...
  inputs = {
    nedryland.url = github:goodbyekansas/nedryland/8.3.1;
    nedryglot.url = github:goodbyekansas/nedryglot/1.1.0;
  ...
  outputs =
    ...
    in
    {
      ...
      apps = {
        ...
        capellini = {
          type = "app";
          program = "${project.matrix.capellini.rust}/bin/capellini";
        };
        lomax = {
          type = "app";
